...
module.exports = {
    ...
    'url' : `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@express-app-cluster.pmoffnv.mongodb.net/course-tracker?retryWrites=true&w=majority&appName=Express-app-cluster`, 
    'dbName': 'demo'
};
